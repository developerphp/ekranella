            ...
            <div class="block-flat">
                ...
                <form id='#content-form' method="post" enctype="multipart/form-data">
                    ...
                    <div class="row no-margin">
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label class="control-label">{{$as}} Yapılan Kişi</label>
                                <input type="text" name="subject" class="form-control title" value="{{{$item->subject}}}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row no-margin">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" name="summary">{{{$item->summary}}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row no-margin">
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label class="control-label">{{$as}} Giriş Metini</label>
