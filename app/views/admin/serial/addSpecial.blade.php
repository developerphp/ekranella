            ...
            <div class="block-flat">
                ...
                <form id="content-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row no-margin">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                ?>
                                @if($item->airing_date && $item->airing_date != "")
                                    <?php $date = $item->airing_date;
                                    $use = explode(' ', $date); ?>
                                @else
                                    <?php $use = ['', '', ''] ?>
                                @endif
                                <label class="control-label">Bölümün Yayınlanma Tarihi (Opsiyonel)</label>

                                <div class="row dateDiv">
                                    <div class="col-sm-3">
                                        <label class="control-label">Gün</label>
                                        <input type="number" max="31" class="form-control" name="day_number"
                                               value="{{trim($use[0])}}"/>
                                    </div>
                                    <div class="col-sm-3">
                    ...
                    <div class="row no-margin">
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label class="control-label">Bölüm Numarası (Opsiyonel)</label>
                    ...
                    <div class="row no-margin">
                        ...
                        <div class="row no-margin">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label class="control-label">{{$as}} Özel Yazısı</label>
